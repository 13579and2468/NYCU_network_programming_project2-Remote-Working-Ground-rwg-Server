...
pid_t* userid_to_pid = (int*)mmap(NULL,31*sizeof(int),PROT_READ | PROT_WRITE,MAP_SHARED | MAP_ANONYMOUS,-1,0);
...
bool* userpipes_used = (bool*)mmap(NULL,31*31*sizeof(bool),PROT_READ | PROT_WRITE,MAP_SHARED | MAP_ANONYMOUS,-1,0);